...
class source:
    def __init__(self):
        self.results = []
        self.domains = ['putlockerfree.net', 'putlockers.fm']
        self.base_link = 'https://putlockerfree.net'
        self.search_link = '/search-movies/%s.html'
        self.notes = 'both domains have blockage.'
    ...
    def sources(self, url, hostDict):
        try:
            ...
            if 'tvshowtitle' in data:
                r = [(i[0], i[1], re.findall('(.+?)(?:\(\d+\)|)(?:\:|) Season (\d+)$', client_utils.replaceHTMLCodes(i[2]))) for i in results]
